...
export const baseApi = createApi({
  ...
  tagTypes: ['DashboardTasks', 'ReportSummary', 'Booking', 'CourierWay', 'PackageType', 'Department', 'User', 'Role', 'ApprovalRouting', 'CompanySettings', 'DeliveryChallan', 'DcReceipt', 'Tracking'],
  endpoints: () => ({}),
});
